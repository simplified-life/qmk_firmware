...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LOWER] = LAYOUT(
      ...
      KC_PSLS, KC_P7, KC_P8, KC_P9, _______, _______, KC_NUM,                   KC_NUM, _______, KC_PSLS, KC_P7, KC_P8, KC_P9, KC_F12,
      ...
      _______, KC_P0, KC_PDOT, KC_PENT, _______,     _______,  QK_BOOT,   QK_BOOT,    _______,   _______, KC_P0, KC_PDOT, KC_PENT, _______
      ),
