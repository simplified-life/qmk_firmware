...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
      KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_WWW_REFRESH,                                           KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
      ...
      KC_LCTL, KC_LALT, KC_LBRC, KC_RBRC, KC_LGUI,  KC_SPC,   MO(1),    MO(0),   KC_ENT,  KC_DEL,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),

	[1] = LAYOUT(
      _______, KC_F1, KC_F2, KC_F3, KC_F4,   KC_F5,                                       KC_F6,   KC_F7,   KC_F8,  KC_F9, KC_F10, KC_F11,
      _______, _______, KC_UP, _______, _______, _______,                                      KC_PSLS,  KC_P7, KC_P8, KC_P9, KC_P0, KC_BSPC,
      _______, KC_LEFT, KC_DOWN, KC_RGHT, KS_MS_BTN1, KS_MS_BTN2, _______, _______,  _______,  _______, KC_PMNS, KC_P4, KC_P5, KC_P6, KC_PAST, KC_F12,
	...
	[2] = LAYOUT(
      _______, KC_F1, KC_F2, KC_F3, KC_F4,   KC_F5,                                       KC_F6,   KC_F7,   KC_F8,  KC_F9, KC_F10, KC_F11,
      KC_PSLS, KC_P7, KC_P8, KC_P9, _______, KC_NLCK,                                    KS_MS_BTN1,   KS_MS_BTN2, KC_NO, KC_NO, KC_NO, KC_F12,
      KC_CAPS, KC_P4, KC_P5, KC_P6, KC_LCTL, KC_SLCK, _______, _______,  _______,  _______, TT(0), KC_NO, KC_NO, KC_NO_BTN3, KC_NO, _______,
      _______, KC_P1, KC_P2, KC_P3, _______, _______, _______, _______,  _______, _______, _______, _______,  KC_NO, KC_NO, KC_NO, _______,
      _______, KC_P0, KC_PDOT, KC_PENT, _______,     _______,  _______,   _______,    _______,   _______,     _______, _______, _______, _______
      ),
	...
	[3] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_MOD, RGB_SPI, RGB_HUI, RGB_SAI, RGB_VAI,
      _______, _______, _______, _______, _______,      _______,     _______, _______,     _______,      RGB_RMOD, RGB_SPD, RGB_HUD, RGB_SAD, RGB_VAD
      )

};

//MO(0) = {KC_LCTL,KC_LALT,KC_TAB}
//MO(1) = {KC_LGUI,KC_LSFT,KC_S}
