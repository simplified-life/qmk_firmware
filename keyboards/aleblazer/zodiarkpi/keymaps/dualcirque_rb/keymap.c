...
//QWERTY / BASE
	[0] = LAYOUT(
      ...
      KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     _______, _______,  _______, _______,   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      SC_SENT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,LT(1,KC_GRV), KC_BSLS,  KC_EQL,  TT(1),    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
      KC_LCTL, KC_LALT, KC_LBRC, KC_RBRC, KC_LGUI,  KC_SPC,            LSG(KC_S),  KC_SPC,          KC_ENT,  KC_DEL,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
//NUMPAD
	[1] = LAYOUT(
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                                         KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,
      _______, _______, KC_UP,   _______, KC_BSPC, KC_NUM,                                        KC_PPLS, KC_P7,   KC_P8,   KC_P9,    KC_P0,   _______,
      _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  KC_SCRL, _______, _______,  _______, _______,  KC_PMNS, KC_P4,   KC_P5,   KC_P6,    KC_PAST, KC_F12,
      _______, _______, _______, _______, KC_MPLY, KC_MUTE, KC_VOLD, KC_VOLU,  RGB_TOG, TO(0),    KC_PDOT, KC_P1,   KC_P2,   KC_P3,    KC_PSLS, KC_PEQL,
...
//MOUSE
	[2] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, DG_BRI,   DG_VOL, DG_RWFF,   RGB_TOG,  TO(0),   KC_F5,      _______,      KC_NO,   KC_NO,  KC_NO,   _______,
...
//SETTINGS
	[3] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, TO(0),     RGB_TOG, RGB_MOD, RGB_SPI, RGB_HUI, RGB_SAI, RGB_VAI,
...
//COLEMAK DH
    [4] = LAYOUT(
      ...
      _______, _______, _______, _______,    KC_D, _______, _______, _______, _______, TO(0),      KC_K,    KC_H, _______, _______, _______, _______,
